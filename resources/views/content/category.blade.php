...
<h2 style=" color:green;font-size:60px;"  class="	glyphicon glyphicon-user"> {{ $post->pub_name }}  </h2>
<h3>
        ...
        <p> 
                ...
                <p><span style="font-size:30px;" class="glyphicon glyphicon-time"></span> Posted on {{$post->created_at}}
        ...
        <div class="comments">
                ...
                <div class="comment">
                <p span class="glyphicon glyphicon-time"> {{ $comment->created_at}} </p>
                 <p> {{ $comment->body }} </p>
                </div>
                <br>
                @endforeach
